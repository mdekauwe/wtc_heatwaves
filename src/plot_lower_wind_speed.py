...
def main(fname):
    ...
    ax1.scatter(x, Et_hw, color='black', s=5, alpha=0.7, label="Wind=8 m s$^{-1}$")
    ax1.scatter(x, Et_hw2, color='green', s=5, alpha=0.7, label="Wind=3 m s$^{-1}$")
    ...
    #            pad_inches=0.1)
    fig.savefig("plots/slower_wind_speed.png", dpi=300, bbox_inches='tight',
                pad_inches=0.1)
    #plt.show()
